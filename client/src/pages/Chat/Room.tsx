...
// import { useParams } from 'react-router-dom';
// import { io, Socket } from 'socket.io-client';
// import { useApi } from "../../lib/hooks/use_api"; // Add the useApi hook
...
//   const [newMessage, setNewMessage] = useState<string>('');
//   const [socket, setSocket] = useState<Socket | null>(null);
//   const [user, setUser] = useState<{ id: string } | null>(null); // Store user info
//   const api = useApi();
...
//     if (id) {
//       socket.emit('join-room', id); // Join the specific room by ID
//     }
...
//   const handleSendMessage = async () => {
//     if (!newMessage.trim() || !user) return; // Ensure user is available
...
//         body: JSON.stringify({
//           content: newMessage,
//           chatRoomId: parseInt(id!), // assuming id is always defined
//           senderId: user.id, // Use the current user ID
//         }),
//       });
...
//   useEffect(() => {
//     if (id) fetchMessages();  // Fetch initial messages on component mount
