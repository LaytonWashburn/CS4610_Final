...
import { Link, useNavigate } from "react-router-dom"; // fixed missing '-dom'
...
export const SignIn = () => {
  ...
  // Set up the socket without events for now (no handlers needed at sign in)
  ...
  async function signIn(e: FormEvent) {
    ...
    if (!res.error && res.authToken) {
      ...
      const decoded = jwtDecode(res.authToken) as any;

      if (decoded.isTutor && socket) {
        emit("tutor-status", {
